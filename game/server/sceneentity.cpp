...
public:
	...
	virtual void			Think();
			...
			CUtlVector< CHandle< CSceneEntity > >* GetActiveScenes()
			{
...
// Data
public:
	//CUtlVector<EmitSound_t> SpeechSounds;
...
{
	/*if (SpeechSounds.Count())
		SpeechSounds.FastRemove(SpeechSounds.Count()-1);*/
