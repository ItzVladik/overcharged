...
{
	if (pTarget->IsEffectActive(EF_BRIGHTLIGHT) || pTarget->IsEffectActive(EF_DIMLIGHT) || pTarget->IsEffectActive(EF_BATTERYLIGHT) || pTarget->IsEffectActive(EF_HEALTHLIGHT) || pTarget->IsEffectActive(EF_FRAGLIGHT) || pTarget->IsEffectActive(EF_FRAGSLIGHT) || pTarget->IsEffectActive(EF_FRAGFLIGHT) || pTarget->IsEffectActive(EF_EGONDISSOLVELIGHT))
		return true;
