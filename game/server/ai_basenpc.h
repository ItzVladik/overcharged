...
public:
	...
	void				EmitNpcSound(const char* soundName, int iEntIndex);
	//---------------------------------
...
protected:
	...
	void				EmitNPCSound(const char* soundName, CBaseCombatCharacter *pCharacter, int entIndex );

	virtual bool		CanBecomeServersideRagdoll() { return true; }
private:
	int					frdShootsCount;
	int					frdShootsBorder;
...
public:
	...
	virtual void		SetSchedule(CAI_Schedule *pNewSchedule, bool DontClearGoal = false);	// BriJee: Overcharged FIX from Human Error codebase
...
inline void CAI_BaseNPC::FireBulletsShotgun(int cShots, const Vector &vecSrc,
	const Vector &vecDirShooting, const Vector &vecSpread, float flDistance,
	int iAmmoType, int iTracerFreq, int firingEntID, int attachmentID,
	int iDamage, CBaseEntity *pAttacker, bool bFirstShotAccurate)
{
...
inline void CAI_BaseNPC::FireBulletsVehicle(int cShots, const Vector &vecSrc,
	const Vector &vecDirShooting, const Vector &vecSpread, float flDistance,
	int iAmmoType, int iTracerFreq, int firingEntID, int attachmentID,
	int iDamage, CBaseEntity *pAttacker, bool bFirstShotAccurate)
{
