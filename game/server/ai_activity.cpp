...
void CAI_BaseNPC::InitDefaultActivitySR(void) 
{
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT);
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT_SILENCED);
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_INSPECT );
	ADD_ACTIVITY_TO_SR( ACT_VM_DRAW_INSPECT_SILENCED );
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT1);
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT2);
	ADD_ACTIVITY_TO_SR(ACT_VM_INSPECT3);
	ADD_ACTIVITY_TO_SR(ACT_VM_ADMIRE);
	ADD_ACTIVITY_TO_SR(ACT_VM_ADMIRE1);
	ADD_ACTIVITY_TO_SR(ACT_VM_ADMIRE2);
	ADD_ACTIVITY_TO_SR(ACT_VM_ADMIRE3);
	...
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_IRONSIGHTED1 );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_IRONSIGHTED2 );
	ADD_ACTIVITY_TO_SR( ACT_VM_PRIMARYATTACK_IRONSIGHTED3 );
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_WALL);
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_MELEE);				// BriJee OVR: New VM activities
	ADD_ACTIVITY_TO_SR(ACT_VM_HOLSTER_SILENCED);
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_SWITCHMODE);
...
//===========================
	...
	ADD_ACTIVITY_TO_SR( ACT_SHOTGUN_PUMP_DOUBLE );
...
//===========================
	...
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_MIDEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_SHOOTLAST_IRONSIGHTED);
	ADD_ACTIVITY_TO_SR(ACT_VM_PRIMARYATTACK_MIDEMPTY_IRONSIGHTED);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOADEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_RELOADMIDEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_MIDEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_SPRINT_MIDEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_WALK_MIDEMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_LOWERED_EMPTY);

	//ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_WALK_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_SPRINT_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_WALL_EMPTY);
	ADD_ACTIVITY_TO_SR(ACT_VM_IDLE_IS_EMPTY);
