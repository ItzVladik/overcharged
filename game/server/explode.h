...
void ExplosionCreate(const Vector &center, const QAngle &angles,
	CBaseEntity *pOwner, int magnitude, int radius, bool doDamage, bool bSimplefield, float flExplosionForce = 0.0f, bool bSurfaceOnly = false, bool bSilent = false, int iCustomDamageType = -1);
...
void ExplosionCreate(const Vector &center, const QAngle &angles,
	CBaseEntity *pOwner, int magnitude, int radius, int nSpawnFlags, bool bSimplefield,
