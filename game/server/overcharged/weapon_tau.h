...
#define TAU_BEAM_SPRITE		"effects/gauss/beam.vmt"

#define	TAU_CHARGE_TIME		0.2f
#define	MAX_TAU_CHARGE		16
#define	MAX_TAU_CHARGE_TIME		3
#define	DANGER_TAU_CHARGE_TIME	10
