...
class CNPC_Gargantua : public CAI_BaseNPC
{
	DECLARE_CLASS(CNPC_Gargantua, CAI_BaseNPC);
public:
...
private:
	...
	bool		DispatchParticleOnce;	// BJ: Flame particle
	//bool		IgniteNpcOnce;	// BJ: Flame particle
};
