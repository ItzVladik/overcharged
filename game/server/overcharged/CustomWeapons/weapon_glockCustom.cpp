#include "cbase.h"
#include "weapon_glockCustom.h"

#include "tier0/memdbgon.h"


IMPLEMENT_SERVERCLASS_ST(CWeaponGlockC1, DT_WeaponGlockC1)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_glockCustom1, CWeaponGlockC1);
PRECACHE_WEAPON_REGISTER(weapon_glockCustom1);

BEGIN_DATADESC(CWeaponGlockC1)

END_DATADESC()

acttable_t	CWeaponGlockC1::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponGlockC1);





IMPLEMENT_SERVERCLASS_ST(CWeaponGlockC2, DT_WeaponGlockC2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_glockCustom2, CWeaponGlockC2);
PRECACHE_WEAPON_REGISTER(weapon_glockCustom2);

BEGIN_DATADESC(CWeaponGlockC2)

END_DATADESC()

acttable_t	CWeaponGlockC2::m_acttable[] =
{
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },		// L1ght 15 : MP animstate
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
	{ ACT_HL2MP_IDLE_CROUCH, ACT_HL2MP_IDLE_CROUCH_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponGlockC2);




IMPLEMENT_SERVERCLASS_ST(CWeaponGlockC3, DT_WeaponGlockC3)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_glockCustom3, CWeaponGlockC3);
PRECACHE_WEAPON_REGISTER(weapon_glockCustom3);

BEGIN_DATADESC(CWeaponGlockC3)

END_DATADESC()

acttable_t	CWeaponGlockC3::m_acttable[] =
{
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },		// L1ght 15 : MP animstate
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
	{ ACT_HL2MP_IDLE_CROUCH, ACT_HL2MP_IDLE_CROUCH_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponGlockC3);