#include "cbase.h"
#include "weapon_uspCustom.h"

#include "tier0/memdbgon.h"


IMPLEMENT_SERVERCLASS_ST(CWeaponUSPC1, DT_WeaponUSPC1)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_uspCustom1, CWeaponUSPC1);
PRECACHE_WEAPON_REGISTER(weapon_uspCustom1);

BEGIN_DATADESC(CWeaponUSPC1)

END_DATADESC()

acttable_t	CWeaponUSPC1::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponUSPC1);





IMPLEMENT_SERVERCLASS_ST(CWeaponUSPC2, DT_WeaponUSPC2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_uspCustom2, CWeaponUSPC2);
PRECACHE_WEAPON_REGISTER(weapon_uspCustom2);

BEGIN_DATADESC(CWeaponUSPC2)

END_DATADESC()

acttable_t	CWeaponUSPC2::m_acttable[] =
{
	{ ACT_HL2MP_IDLE,                    ACT_HL2MP_IDLE_PISTOL,                    false },		// L1ght 15 : MP animstate
    { ACT_HL2MP_RUN,                    ACT_HL2MP_RUN_PISTOL,                    false },
    { ACT_HL2MP_IDLE_CROUCH,            ACT_HL2MP_IDLE_CROUCH_PISTOL,            false },
...
IMPLEMENT_ACTTABLE(CWeaponUSPC2);




IMPLEMENT_SERVERCLASS_ST(CWeaponUSPC3, DT_WeaponUSPC3)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_uspCustom3, CWeaponUSPC3);
PRECACHE_WEAPON_REGISTER(weapon_uspCustom3);

BEGIN_DATADESC(CWeaponUSPC3)

END_DATADESC()

acttable_t	CWeaponUSPC3::m_acttable[] =
{
	{ ACT_HL2MP_IDLE,                    ACT_HL2MP_IDLE_PISTOL,                    false },		// L1ght 15 : MP animstate
    { ACT_HL2MP_RUN,                    ACT_HL2MP_RUN_PISTOL,                    false },
    { ACT_HL2MP_IDLE_CROUCH,            ACT_HL2MP_IDLE_CROUCH_PISTOL,            false },
...
IMPLEMENT_ACTTABLE(CWeaponUSPC3);