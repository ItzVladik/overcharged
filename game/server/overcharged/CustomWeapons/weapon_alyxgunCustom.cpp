#include "cbase.h"
#include "weapon_alyxgunCustom.h"

#include "tier0/memdbgon.h"


IMPLEMENT_SERVERCLASS_ST(CWeaponAlyxGunC1, DT_WeaponAlyxGunC1)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_alyxgunCustom1, CWeaponAlyxGunC1);
PRECACHE_WEAPON_REGISTER(weapon_alyxgunCustom1);

BEGIN_DATADESC(CWeaponAlyxGunC1)
END_DATADESC()

acttable_t	CWeaponAlyxGunC1::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponAlyxGunC1);
...
IMPLEMENT_SERVERCLASS_ST(CWeaponAlyxGunC2, DT_WeaponAlyxGunC2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_alyxgunCustom2, CWeaponAlyxGunC2);
PRECACHE_WEAPON_REGISTER(weapon_alyxgunCustom2);

BEGIN_DATADESC(CWeaponAlyxGunC2)
END_DATADESC()

acttable_t	CWeaponAlyxGunC2::m_acttable[] =
{
	{ ACT_RANGE_ATTACK1, ACT_RANGE_ATTACK_PISTOL, true },
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponAlyxGunC2);
...
IMPLEMENT_SERVERCLASS_ST(CWeaponAlyxGunC3, DT_WeaponAlyxGunC3)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_alyxgunCustom3, CWeaponAlyxGunC3);
PRECACHE_WEAPON_REGISTER(weapon_alyxgunCustom3);

BEGIN_DATADESC(CWeaponAlyxGunC3)
END_DATADESC()

acttable_t	CWeaponAlyxGunC3::m_acttable[] =
{
	{ ACT_RANGE_ATTACK1, ACT_RANGE_ATTACK_PISTOL, true },
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponAlyxGunC3);
