#include "cbase.h"
#include "weapon_deagleCustom.h"
#include "tier0/memdbgon.h"




IMPLEMENT_SERVERCLASS_ST(CWeaponDeagleC1, DT_WeaponDeagleC1)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_deagleCustom1, CWeaponDeagleC1);
PRECACHE_WEAPON_REGISTER(weapon_deagleCustom1);

BEGIN_DATADESC(CWeaponDeagleC1)

END_DATADESC()

acttable_t	CWeaponDeagleC1::m_acttable[] =
{
...
IMPLEMENT_ACTTABLE(CWeaponDeagleC1);




IMPLEMENT_SERVERCLASS_ST(CWeaponDeagleC2, DT_WeaponDeagleC2)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_deagleCustom2, CWeaponDeagleC2);
PRECACHE_WEAPON_REGISTER(weapon_deagleCustom2);

BEGIN_DATADESC(CWeaponDeagleC2)

END_DATADESC()

acttable_t	CWeaponDeagleC2::m_acttable[] =
{
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },		// L1ght 15 : MP animstate
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
	{ ACT_HL2MP_IDLE_CROUCH, ACT_HL2MP_IDLE_CROUCH_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponDeagleC2);





IMPLEMENT_SERVERCLASS_ST(CWeaponDeagleC3, DT_WeaponDeagleC3)
END_SEND_TABLE()

LINK_ENTITY_TO_CLASS(weapon_deagleCustom3, CWeaponDeagleC3);
PRECACHE_WEAPON_REGISTER(weapon_deagleCustom3);

BEGIN_DATADESC(CWeaponDeagleC3)

END_DATADESC()

acttable_t	CWeaponDeagleC3::m_acttable[] =
{
	{ ACT_HL2MP_IDLE, ACT_HL2MP_IDLE_PISTOL, false },		// L1ght 15 : MP animstate
	{ ACT_HL2MP_RUN, ACT_HL2MP_RUN_PISTOL, false },
	{ ACT_HL2MP_IDLE_CROUCH, ACT_HL2MP_IDLE_CROUCH_PISTOL, false },
...
IMPLEMENT_ACTTABLE(CWeaponDeagleC3);