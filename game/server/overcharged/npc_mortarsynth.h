...
// Spawnflags
//------------------------------------
#define SF_MSYNTH_NO_DYNAMIC_LIGHT	(1 << 16)
#define SF_MSYNTH_STRIDER_SCOUT		(1 << 17)
...
// Purpose: 
//-----------------------------------------------------------------------------
class CNPC_MSynth : public CNPC_BaseMSynth
{
	DECLARE_CLASS(CNPC_MSynth, CNPC_BaseMSynth);
...
public:
	...
	//virtual char	*GetScannerSoundPrefix(void);	// BJ not needed
	void			Spawn(void);
	void			Activate();
	...
	void			InspectTarget(inputdata_t &inputdata, MSynthFlyMode_t eFlyMode);
...
public:
	...
	bool			IsStriderScout() { return HasSpawnFlags(SF_MSYNTH_STRIDER_SCOUT); }
