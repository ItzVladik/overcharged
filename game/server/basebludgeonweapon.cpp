...
void CBaseHLBludgeonWeapon::ItemPostFrame( void )
{
	...
	{
		//if (pOwner && ((m_iClip1 <= (GetMaxClip1() / 4)) && m_iClip1 != 0 && m_iClip1 <= 8))
			//EmitSound("Weapon_low_ammo.low_ammo");//WeaponSound(LOW_AMMO);
...
void CBaseHLBludgeonWeapon::AddViewKick(void)
{
	...
	punchAng.x = random->RandomFloat(-2.0f, 2.0f);
...
void CBaseHLBludgeonWeapon::Swing( int bIsSecondary )
{
	...
	// Send the player 'attack' animation.	//overcharged
