...
static const char * const pszShaderReplaceDict[][2] = {
	...
	{ "VertexLitGeneric_dx9", "DEFERRED_MODEL" },
	{ "VertexLitGeneric_dx8", "DEFERRED_MODEL" },
	{ "LightmappedGeneric", "DEFERRED_BRUSH" },
	{ "LightmappedGeneric_dx9", "DEFERRED_BRUSH" },
	{ "LightmappedGeneric_dx8", "DEFERRED_BRUSH" },
	{ "WorldVertexTransition", "DEFERRED_BRUSH" },
	{ "WorldVertexTransition_dx9", "DEFERRED_BRUSH" },
	{ "WorldVertexTransition_dx8", "DEFERRED_BRUSH" },
	{ "DecalModulate", "DEFERRED_DECALMODULATE" },
	{ "DecalModulate_dx9", "DEFERRED_DECALMODULATE" },
	{ "DecalModulate_dx8", "DEFERRED_DECALMODULATE" }
	/*{ "Water", "SDK_Water" },
	{ "Water_dx9", "SDK_Water" },
	{ "Water_dx8", "SDK_Water" }*/
};
