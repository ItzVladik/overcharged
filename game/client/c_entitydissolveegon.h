...
#ifndef C_ENTITY_DISSOLVE_EGON_H
#define C_ENTITY_DISSOLVE_EGON_H
...
//-----------------------------------------------------------------------------
class C_EntityDissolveEgon : public C_BaseEntity, public IMotionEvent
{
public:
	DECLARE_CLIENTCLASS();
	DECLARE_CLASS(C_EntityDissolveEgon, C_BaseEntity);

	C_EntityDissolveEgon(void);
