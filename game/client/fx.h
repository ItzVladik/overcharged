...
void FX_LaserSpark(const Vector &position, const Vector &direction, const Vector &surfaceNormal, int iScale = 1);
void FX_LaserSparkMuzzle(const Vector &position, const Vector &direction, int iScale = 1);
void FX_BloodDrips(const Vector &position, const Vector &direction, const Vector &surfaceNormal, int iScale = 1);
...
void FX_CommonTracer(const char *name, Vector& start, Vector& end, float velocity, float length, float scale, bool makeWhiz = true);
