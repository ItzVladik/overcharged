...
ConVar	sv_rollspeed("sv_rollspeed", "200", /*FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY*/ FCVAR_REPLICATED | FCVAR_ARCHIVE);						// BriJee OVR: I need this...
ConVar	sv_rollangle("sv_rollangle", "0", /*FCVAR_NOTIFY | FCVAR_REPLICATED | FCVAR_DEVELOPMENTONLY*/ FCVAR_REPLICATED | FCVAR_ARCHIVE, "Max view roll angle");
#endif // CSTRIKE_DLL
