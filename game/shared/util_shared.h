...
/*inline float OC_GLOBAL_SOUND_PITCH(float val = 1.f)
{
	return val;
}*/


/*struct SoundGlobalPitch
{
	float OC_GLOBAL_SOUND_PITCH;
	void UTIL_SetPitch(float pitch)
	{
		OC_GLOBAL_SOUND_PITCH = pitch;
	}
	float UTIL_GetPitch()
	{
		return OC_GLOBAL_SOUND_PITCH;
	}
};
SoundGlobalPitch ph;*/
