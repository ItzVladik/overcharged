...
void ActivityList_RegisterSharedActivities( void )
{
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT_SILENCED);
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_INSPECT );
	REGISTER_SHARED_ACTIVITY( ACT_VM_DRAW_INSPECT_SILENCED );
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_INSPECT3);
	REGISTER_SHARED_ACTIVITY(ACT_VM_ADMIRE);
	REGISTER_SHARED_ACTIVITY(ACT_VM_ADMIRE1);
	REGISTER_SHARED_ACTIVITY(ACT_VM_ADMIRE2);
	REGISTER_SHARED_ACTIVITY(ACT_VM_ADMIRE3);
	...
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_IRONSIGHTED1 );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_IRONSIGHTED2 );
	REGISTER_SHARED_ACTIVITY( ACT_VM_PRIMARYATTACK_IRONSIGHTED3 );
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_WALL);
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_MELEE);					// BriJee OVR: New VM activities
	REGISTER_SHARED_ACTIVITY(ACT_VM_HOLSTER_SILENCED);
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_SWITCHMODE);
...
//===========================
	...
	REGISTER_SHARED_ACTIVITY(ACT_SHOTGUN_PUMP2);
	REGISTER_SHARED_ACTIVITY(ACT_SHOTGUN_PUMP_DOUBLE);
	REGISTER_SHARED_ACTIVITY(ACT_SHOTGUN_PUMP2_DOUBLE);
...
//HL2MP
	...
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_MIDEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SHOOTLAST_IRONSIGHTED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_PRIMARYATTACK_MIDEMPTY_IRONSIGHTED);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOADEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_RELOADMIDEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_MIDEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_SPRINT_MIDEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_WALK_MIDEMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_LOWERED_EMPTY);

	//REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WALK_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_SPRINT_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_WALL_EMPTY);
	REGISTER_SHARED_ACTIVITY(ACT_VM_IDLE_IS_EMPTY);
