...
./waf configure -T release --build-game=episodic --prefix=srceng-mod-launcher/android --android=armeabi-v7a-hard,host,21 -enable-rtt-shadows --target=../armeabi-v7a --32bits --enable-opus --togles --disable-warns &&
./waf install --target=game_shader_dx9,game_shader_dx6,client,server,shadereditor_2013,togl --strip
