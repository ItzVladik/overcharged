...
python3 waf configure -T release --build-game=overcharged --prefix=srceng-mod-launcher/android --android=aarch64,host,21 --target=../aarch64 --enable-opus --togles --disable-warns &&
python3 waf install --target=tier0,game_shader_dx9,game_shader_dx6,client,server,shadereditor_2013,togl --strip

set +e

export ICON=lc.png
export PACKAGE=overcharged
export APP_NAME="Half-Life 2: Overcharged"
