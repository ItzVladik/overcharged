...
extern int g_nYou_Must_Add_Public_vgui_controls_editor_editor_editor_vgui_controls_editor_editor_editorCpp_To_Your_Project;
...
{
	g_nYou_Must_Add_Public_vgui_controls_editor_editor_editor_vgui_controls_editor_editor_editorCpp_To_Your_Project = 1;

	// If you hit this error, then you need to include memoverride.cpp in the project somewhere or else
	// you'll get crashes later when vgui_controls_editor_editor_editor allocates KeyValues and vgui tries to delete them.
	...
	{
		Warning( "vgui_controls_editor_editor_editor is missing a required interface!\n" );
		return false;
	}
