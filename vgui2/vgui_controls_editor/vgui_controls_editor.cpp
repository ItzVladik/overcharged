...
#include "vgui_controls_editor/expandbutton.h"
...
int g_nYou_Must_Add_Public_vgui_controls_editor_editor_editor_vgui_controls_editor_editor_editorCpp_To_Your_Project = 0;
